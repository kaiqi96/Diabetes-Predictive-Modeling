...
#Random forest with mtry modified (mtry 3 has the best performance with lowest error rate)
...
#Random forest with mtry modified - second model (result showed mtry 3 and 5 have no significant difference)
